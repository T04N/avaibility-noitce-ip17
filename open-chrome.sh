...
echo "🚀 Opening Chrome for iPhone 17 Monitor..."
echo ""
...
echo "   5. Go to: https://www.apple.com/jp/shop/buy-iphone/iphone-17"
echo ""
echo "🎯 Extension will automatically:"
echo "   • Select Lavender color"
...
# Wait a moment then try to open iPhone 17 page
sleep 2
echo "📱 Attempting to open iPhone 17 page..."
osascript -e 'tell application "Google Chrome" to open location "https://www.apple.com/jp/shop/buy-iphone/iphone-17"' 2>/dev/null || echo "   Please manually go to: https://www.apple.com/jp/shop/buy-iphone/iphone-17"
